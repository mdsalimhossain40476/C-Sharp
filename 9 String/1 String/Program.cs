    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            /*
                ...
                একটি String ভেরিয়েবলের মধ্যে ডাবল " " কোটেশন দ্বারা ঘেরা অক্ষরের একটি সংগ্রহ থাকে।
            ...
            */
            ...
            /*
                ...
                String Length
                C# তে একটি স্ট্রিং আসলে একটি অবজেক্ট, যার মধ্যে স্ট্রিং-এ নির্দিষ্ট অপারেশন 
                কার্যকর করার জন্য প্রোপার্টি এবং পদ্ধতি রয়েছে। উদাহরণস্বরূপ, একটি স্ট্রিংয়ের দৈর্ঘ্য Length প্রোপার্টি দিয়ে পাওয়া যায়।
            */
